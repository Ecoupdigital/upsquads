...
#### Slide 1 (ou Imagem unica)
**Texto na imagem**: {todo texto visivel transcrito literalmente}
**Descricao visual**: {descricao do layout, cores, fotos, graficos, elementos visuais}

#### Slide 2 (apenas para carrosseis)
**Texto na imagem**: {todo texto visivel transcrito literalmente}
**Descricao visual**: {descricao}

#### Slide N...

### Transcricao do Audio (apenas para videos)
> {Transcricao completa do Whisper}

### Analise de Tom (apenas para videos)
{Analise de Claude sobre tom, estilo, energia}
